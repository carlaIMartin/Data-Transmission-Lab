        ...
        "children": [
          { "name": "Level 2: A0RR",
			"children": [
				{ "name": "Level 3: A0RRR",
				"children": [
						{ "name": "Level 4: A0RRRR - space (frequency" },
						{ "name": "Level 4: A0RRRL - 3 (frequency)" }
					]
				},
				{ "name": "Level 3: A0RLL - q (frequency)" }
			]
		  },
          { "name": "Level 2: A0RL - M (frequency)" }
        ]
      },
      { "name": "Level 1: A0L",
        "children": [
          { "name": "Level 2: A0LR - A (frequency)" },
          { "name": "Level 2: A0LL - * (frequency)" }
        ]
	  }
    ]
};
